...
print('  G9:',out['summary']['G9']); print('  G10:',out['summary']['G10']); print('  sens:',{k:[round(x) for x in v] for k,v in out['summary']['sens'].items()}); print('  catsum:',[round(x) for x in out['summary']['catsum']]); print('  A:E',out['summary']['AtoE'])
