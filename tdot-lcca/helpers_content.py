...
SECTIONS_ECON = [
 ('5. Economic parameters (D33 analysis period, D34 discount rate, salvage)',
  ...
  [['TDOT policy discount rate (workbook default)', "='General Information'!$D$34", '%', '', '', 'live from General Information D34', 'this workbook'],
   ...
   ['Salvage: HMA', "='Maintenance Policies'!$D$32", 'fraction of the last mill-and-overlay', '', '', 'computed in Maintenance Policies D32: remaining life of the year-20 overlay at the analysis period, over a 16-year overlay life', 'this workbook'],
   ['Salvage: PCC', "='Maintenance Policies'!$D$46", 'fraction of initial construction', '', '', 'computed in Maintenance Policies D46: remaining life of the initial construction at the analysis period, over a 40-year life', 'this workbook'],
   ['Salvage method in FAA / AAPTP guidance', 'remaining life / expected life x cost of the last treatment (straight line)', '', 2011, '', 'the method is theirs, and from v1.2.0 the workbook computes it rather than carrying the two fractions as constants', AAPTP]],
