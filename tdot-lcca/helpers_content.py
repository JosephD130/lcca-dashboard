...
SECTIONS_ECON = [
 ('5. Economic parameters (D33 analysis period, D34 discount rate, salvage)',
  ...
  [['TDOT policy discount rate (workbook default)', "='General Information'!$D$34", '%', '', '', 'live from General Information D34', 'this workbook'],
   ...
   ['Salvage: HMA', "='Maintenance Policies'!$D$32", 'fraction of the last mill-and-overlay', '', '', 'live from Maintenance Policies D32 (policy: 2 of 16 years remaining; Table 1 overlays at year 20, which would leave 6 of 16)', 'this workbook'],
   ...
   ['Salvage method in FAA / AAPTP guidance', 'remaining life / expected life x cost of the last treatment (straight line)', '', 2011, '', 'the method is theirs; the two fractions above are the workbook\'s own and are the decision flagged in the change notes', AAPTP]],
