...
def build_readme(wb):
    ...
    ('Purpose: show the two 2026-05-21 analyzes side by side with the sensitivity, break-even and closure views the framework workbook does not produce. Companion to TDOA_LCCA_Framework v1.2.0; base costs, closure days and policies are copied from those files.',F_B),
    ('',F_B),('How to use',F_H),
