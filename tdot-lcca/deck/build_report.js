...
children.push(table([
  ...
  ['Two worked examples, three and four alternatives', 'GKT Runway 10-28 (no shoulders, HMA / 9 in PCC / 11 in PCC) and MKL Runway 2-20 (25 ft shoulders, two HMA / two PCC) built on the blank template through the UNO API with quantities derived from a target section (verification/examples/run_example.py)', 'Item costs, initial totals, every activity present worth, NPW, category sums, closure days, cumulative cost, verdict, vs. lowest, EUAC, the 3 percent point of the sensitivity curve and the section read-back all agree with an independent calculation: 42 checks on GKT and 57 on MKL, no failures, no error cells. GKT: 11 in PCC lowest at $5,852,247, HMA lowest above about 4 percent. MKL: 9 in PCC lowest at $14,066,568 at every rate; the shoulder reading returns the designed 8/6/6, 9/6/6, 10/10 and 11/6 in sections'],
